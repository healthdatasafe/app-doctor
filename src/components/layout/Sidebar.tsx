...
import { getAppManaging, logout } from '../../services/dr-lib';
...
function Sidebar() {
  ...
  useEffect(() => {
    const updateForms = async () => {
      ...
      const drConnectionInfo = await appManager.connection.accessInfo();
      setUser(drConnectionInfo.user.username as string);
